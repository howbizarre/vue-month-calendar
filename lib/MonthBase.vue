...
.month-container {
  @apply 
    ...
    rounded-lg p-3 max-[300px]:w-[300px] max-[480px]:w-full sm:w-[350px] relative;
}

.month-grid { @apply grid grid-cols-7 gap-y-1 sm:gap-y-2 py-1 sm:py-3; }

.month-header { @apply grid grid-cols-5 pl-3 pr-2 sm:p-3; }
